...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=#967600
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=#ffbf00
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		"mode_indicator ${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR} #deda14"
	)
fi
